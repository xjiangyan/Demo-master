...
public class CirlceMenuActivity extends AppCompatActivity implements CircleLayout.OnItemClickListener, CircleLayout.OnItemSelectedListener, CircleLayout.OnCenterClickListener, CircleLayout.OnRotationFinishedListener {
    @BindView(R.id.btn)
    Button mBtn;
    @BindView(R.id.logo)
    ImageView mLogo;
    ...
    private void initwatermark() {
        ...
        //                Toast.makeText(CirlceMenuActivity.this, "点击了", Toast.LENGTH_SHORT).show();
        //            }
        //        });
