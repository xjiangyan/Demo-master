package com.example.hp.demo.transition;
...
public class BottomEnterTransition extends Visibility {
    private static final String TAG = "BottomEnterTransition";
    ...
    public BottomEnterTransition(Context context, View bottomView) {
