...
public class PermissionHelper {
    ...
    private final static int RECORD_AUDIO = 103;
    private final static int CAMERA = 104;
    ...
    private PermissionModel[] mPermissionModels = new PermissionModel[]{
            ...
            new PermissionModel("地理位置", Manifest.permission.RECORD_AUDIO, "我们需要读取地理位置来判断你的位置", RECORD_AUDIO)
            , new PermissionModel("相机", Manifest.permission.CAMERA, "我们需要使用相机才能进行拍照", CAMERA)
    };
