...
public class ElasticHeadScrollView extends ScrollView {
    ...
    private ImageView mSelectRecycleView;
    ...
    protected void onScrollChanged(int x, int y, int oldx, int oldy) {
        ...
        int height = mRecyclerView.getHeight() - y + DensityUtil.getBottomStatusHeight(context);
        if (listener != null) {
    ...
    protected void onFinishInflate() {
        ...
        if (getChildCount() > 0) {
            ...
            if (inner.getChildCount() != 1) {
                mRecyclerView = (RecyclerView) inner.findViewById(R.id.recycler_view);
                mSelectRecycleView = (ImageView) inner.findViewById(R.id.p9);
            }
        }
