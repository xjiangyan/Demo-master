...
public class SafeKeyboardView extends LinearLayout {
    ...
    private void initView() {
        ...
        setPadding(DensityUtil.dip2px(getContext(), 20), DensityUtil.dip2px(getContext(), 15), DensityUtil.dip2px(getContext(), 20), DensityUtil.dip2px(getContext(), 10));
        addHeader();
        addGridPasswdView();
    ...
    private void addGridPasswdView() {
        ...
        gridView.setHorizontalSpacing(DensityUtil.dip2px(getContext(), 10));
        gridView.setVerticalSpacing(DensityUtil.dip2px(getContext(), 10));
        addView(gridView);
